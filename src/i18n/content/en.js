export default {
  faqs: [
    {
      question: 'What information do I need before submitting a request?',
      answer:
        'At minimum, provide your name, phone number, preferred contact channel, and basic coverage goals so we can match suitable plans and follow up quickly.',
    },
    {
      question: 'Can I edit my submitted information later?',
      answer:
  ...
  testimonials: [
    {
      ...
      message:
        'I like how plans are grouped clearly and requests are fast. When the team called back, they already knew my details.',
    },
    {
      name: 'Chanon',
      role: 'Life Insurance Customer',
      message:
        'Being able to view and compare multiple plans at once helped me decide on coverage much faster.',
    },
    {
      name: 'Mod',
  ...
  articles: {
    'how-to-choose-health-insurance': {
      title: 'How to Choose Health Insurance for Your Lifestyle and Budget',
      excerpt:
        'Key factors from OPD/IPD coverage limits to conditions many people overlook.',
      category: 'Health',
      readTime: '5 min read',
      ...
      sections: [
        {
          ...
          body: 'If you see doctors regularly or worry about future medical costs, review room rates, treatment coverage, and claim conditions that match your actual lifestyle.',
        },
        {
          heading: 'Look at Both Limits and Cost-Sharing',
          body: 'Some plans have low premiums but deductibles or co-payments — consider these together so costs stay manageable when you claim.',
        },
        {
    ...
    'family-life-insurance-guide': {
      title: 'Family Life Insurance — Where to Start',
      excerpt: 'Guidance on sum assured, term, and budget balanced with family obligations.',
      category: 'Life',
      readTime: '6 min read',
      publishedAt: 'Feb 6, 2026',
      sections: [
        {
          heading: 'Start with Financial Obligations',
          body: 'Sum assured should reflect monthly expenses, debt, and children\'s education so protection is truly adequate.',
        },
        {
          heading: 'Choose Premiums You Can Pay Long-Term',
          body: 'A good plan fits your budget sustainably without hurting family cash flow.',
        },
        {
          heading: 'Think Long-Term, Not Just Today',
          body: 'Long-term planning helps life insurance serve as both protection and part of your family financial plan.',
        },
      ],
    },
    'travel-insurance-checklist': {
      title: 'Travel Insurance Checklist Before Your Trip',
      excerpt: 'Check medical costs, flight delays, and lost baggage before you buy.',
      category: 'Travel',
      readTime: '3 min read',
      publishedAt: 'Jan 18, 2026',
      sections: [
        {
          heading: 'Medical Costs Are Core',
          body: 'Overseas treatment can be costly — choose limits suited to your destination and trip length.',
        },
        {
          heading: 'Flight and Baggage Coverage Together',
          body: 'For connecting flights or multi-city trips, delay and lost baggage coverage reduces mid-trip losses.',
        },
        {
          heading: 'Confirm Coverage Start and End Dates',
          body: 'Before buying, verify coverage aligns with your actual travel dates to avoid gaps.',
        },
      ],
    },
    ...
    'pa-insurance-for-working-age': {
      ...
      sections: [
        {
          heading: 'Start with Commute and Work Style',
          body: 'Frequent travel, motorcycles, field work, or outdoor activities mean higher risk — assess daily habits first.',
        },
        {
          heading: 'Balance Treatment and Income Benefits',
          body: 'Good PA plans cover per-visit treatment, hospital income benefits, and impact on earnings during recovery.',
        },
        {
          heading: 'Compare Exclusions Before Buying',
          body: 'Risk sports, certain vehicles, or pre-existing conditions may have extra terms — read exclusions carefully.',
        },
      ],
    },
  },
